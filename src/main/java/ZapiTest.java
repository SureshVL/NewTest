...
public class ZapiTest{
    ...
    /** URLS */
    private static final String BASE_URL = "https://transform.aia.org";
    ...
    private static final String CREDENTIALS = "sureshforu:Test123";
    //private static final String CREDENTIALS = "zapivl:P@55w0rd123";
   // private static final String CREDENTIALS = " jagal:Value*12123";
    ...
    public static HttpURLConnection createHttpCon1(final String url, final String method)
            throws IOException {
        final HttpURLConnection httpCon;       
        httpCon = (HttpURLConnection) new URL(url).openConnection();  
